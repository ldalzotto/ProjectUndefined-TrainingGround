...
namespace RTPuzzle
{
    ...
    public class InteractiveObjectTypeDefinitionConfiguration : ConfigurationSerialization<InteractiveObjectTypeDefinitionID, InteractiveObjectTypeDefinitionConfigurationInherentData>
    {

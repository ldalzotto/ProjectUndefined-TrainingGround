...
namespace RTPuzzle
{
    public class RangeObjectInitializer : MonoBehaviour
    {
        ...
        public static RangeObjectV2 FromRangeObjectInitialization(RangeObjectInitialization RangeObjectInitialization, GameObject parent)
        {
            ...
            {
                rangeObjectV2 = new SphereRangeObjectV2(new RangeGameObjectV2(parent), (SphereRangeObjectInitialization)RangeObjectInitialization, null);
            }
            else if (RangeObjectInitialization.GetType() == typeof(BoxRangeObjectInitialization))
            {
                rangeObjectV2 = new BoxRangeObjectV2(new RangeGameObjectV2(parent), (BoxRangeObjectInitialization)RangeObjectInitialization, null);
            }
            else if (RangeObjectInitialization.GetType() == typeof(FrustumRangeObjectInitialization))
            {
                rangeObjectV2 = new FrustumRangeObjectV2(new RangeGameObjectV2(parent), (FrustumRangeObjectInitialization)RangeObjectInitialization, null);
            }
            else if (RangeObjectInitialization.GetType() == typeof(RoundedFrustumRangeObjectInitialization))
            {
                rangeObjectV2 = new RoundedFrustumRangeObjectV2(new RangeGameObjectV2(parent), (RoundedFrustumRangeObjectInitialization)RangeObjectInitialization, null);
            }

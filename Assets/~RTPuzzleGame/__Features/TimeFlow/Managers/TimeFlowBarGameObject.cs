    ...
    public class TimeFlowBarGameObject
    {
        ...
        public TimeFlowBarGameObject()
        {
          ...
          var CanvasScaler =  GameObject.FindObjectOfType<CanvasScaler>();
            ...
            (this.timeFlowBarGameObject.transform as RectTransform).sizeDelta = new Vector2(CanvasScaler.referenceResolution.x * 0.75f, CanvasScaler.referenceResolution.y * 0.025f);
            (this.timeFlowBarGameObject.transform as RectTransform).offsetMin = new Vector2(110f, 25f);
            (this.timeFlowBarGameObject.transform as RectTransform).offsetMax = 
                (this.timeFlowBarGameObject.transform as RectTransform).offsetMin + new Vector2(CanvasScaler.referenceResolution.x * 0.75f, CanvasScaler.referenceResolution.y * 0.025f);

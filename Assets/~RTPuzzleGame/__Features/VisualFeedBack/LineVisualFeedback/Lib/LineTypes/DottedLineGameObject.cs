...
namespace RTPuzzle
{
    public class DottedLineGameObject 
    {
        ...
        public int GetInstanceID() { return this.AssociatedGameObject.GetInstanceID(); }
        public void ClearMesh() { this.MeshFilter.mesh = new Mesh(); }
        public Mesh GetMesh() { return this.MeshFilter.mesh; }
    }

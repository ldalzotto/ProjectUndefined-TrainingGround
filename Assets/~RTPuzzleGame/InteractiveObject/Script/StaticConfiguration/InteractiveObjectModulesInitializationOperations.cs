...
namespace RTPuzzle
{
    public static class InteractiveObjectModulesInitializationOperations
    {
        ...
        // </auto-generated>
        //------------------------------------------------------------------------------
        public static void InitializeAILogicColliderModule(InteractiveObjectInitializationObject interactiveObjectInitializationObject, InteractiveObjectType interactiveObjectType)
        {
            interactiveObjectType.GetModule<AILogicColliderModule>().IfNotNull((AILogicColliderModule AILogicColliderModule) => AILogicColliderModule.Init(interactiveObjectInitializationObject.ParentAIObjectTypeReference));
        }
        //------------------------------------------------------------------------------
        // <auto-generated>
        //     This code was generated by a tool.
        // </auto-generated>
        //------------------------------------------------------------------------------
        public static void InitializeInRangeColliderTrackerModule(InteractiveObjectInitializationObject interactiveObjectInitializationObject, InteractiveObjectType interactiveObjectType)
        {

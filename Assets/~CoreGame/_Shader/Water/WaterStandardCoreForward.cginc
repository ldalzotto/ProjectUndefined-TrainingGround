...
#ifndef WATER_STANDARD_CORE_INCLUDED
#define WATER_STANDARD_CORE_INCLUDED
...
half4 fragBase(VertexOutputForwardBase i) : SV_Target{
	//return half4(half3(1,0,0), GetInterpolatedFoamWeight(i));// GetInterpolatedFoamWeight(i) * half4(1,1,1,1);
	return saturate(fragForwardBaseInternal(i) + DepthColor(i) + GetInterpolatedFoamWeight(i));
}
...
#endif // WATER_STANDARD_CORE_INCLUDED

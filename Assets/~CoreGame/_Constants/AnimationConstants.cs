...
public class AnimationConstants
{
    public static Dictionary<PlayerAnimatioNamesEnum, PlayerAnimationConstantsData> PlayerAnimationConstants = new Dictionary<PlayerAnimatioNamesEnum, PlayerAnimationConstantsData>()
    {
        ...
        {PlayerAnimatioNamesEnum.PLAYER_ACTION_CA_PROJECTILE, new PlayerAnimationConstantsData("CA_Projectile", PlyaerAnimationLayerNames.CONTEXT_ACTION_OVERRIDE) },
        {PlayerAnimatioNamesEnum.PLAYER_ACTION_CA_PROJECTILE_THROW, new PlayerAnimationConstantsData("CA_Projectile_Throw", PlyaerAnimationLayerNames.CONTEXT_ACTION_OVERRIDE) },
...
public enum PlayerAnimatioNamesEnum
{
    ...
    PLAYER_ACTION_CA_PROJECTILE,
    PLAYER_ACTION_CA_PROJECTILE_THROW,

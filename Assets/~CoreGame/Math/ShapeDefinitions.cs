...
namespace CoreGame
{
    ...
    public struct FrustumV2
    {
        ...
        {
            return (FrustumTransform.WorldPosition + FrustumTransform.WorldRotation * ((this.DeltaRotation * localPoint) + this.Center).Mul(FrustumTransform.LossyScale)).Round(3);
        }

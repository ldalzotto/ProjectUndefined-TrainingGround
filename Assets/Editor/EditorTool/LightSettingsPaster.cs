...
public class LightSettingsPaster : EditorWindow
{
    ...
    private LightmapEditorSettingsWrapper ExtractLightmapEditorSettingsFromActiveScene()
    {
        ...
        LightmapEditorSettingsWrapper.aoContrast = LightmapEditorSettings.aoContrast;
        LightmapEditorSettingsWrapper.aoAmount = LightmapEditorSettings.aoAmount;
        LightmapEditorSettingsWrapper.lockAtlas = LightmapEditorSettings.lockAtlas;
        LightmapEditorSettingsWrapper.skyLightColor = LightmapEditorSettings.skyLightColor;
        LightmapEditorSettingsWrapper.skyLightIntensity = LightmapEditorSettings.skyLightIntensity;
        LightmapEditorSettingsWrapper.quality = LightmapEditorSettings.quality;
        LightmapEditorSettingsWrapper.bounceBoost = LightmapEditorSettings.bounceBoost;
        LightmapEditorSettingsWrapper.enableAmbientOcclusion = LightmapEditorSettings.enableAmbientOcclusion;
        LightmapEditorSettingsWrapper.finalGatherRays = LightmapEditorSettings.finalGatherRays;
        LightmapEditorSettingsWrapper.finalGatherGradientThreshold = LightmapEditorSettings.finalGatherGradientThreshold;
        LightmapEditorSettingsWrapper.finalGatherInterpolationPoints = LightmapEditorSettings.finalGatherInterpolationPoints;
        LightmapEditorSettingsWrapper.lastUsedResolution = LightmapEditorSettings.lastUsedResolution;
        LightmapEditorSettingsWrapper.bounceIntensity = LightmapEditorSettings.bounceIntensity;
        ...
        LightmapEditorSettingsWrapper.maxAtlasHeight = LightmapEditorSettings.maxAtlasHeight;
        LightmapEditorSettingsWrapper.finalGatherContrastThreshold = LightmapEditorSettings.finalGatherContrastThreshold;
    ...
    private void PasteLightMapEditorSettingsFromWrapper(LightmapEditorSettingsWrapper LightmapEditorSettingsWrapper)
    {
        ...
        LightmapEditorSettings.aoContrast = LightmapEditorSettingsWrapper.aoContrast;
        LightmapEditorSettings.aoAmount = LightmapEditorSettingsWrapper.aoAmount;
        LightmapEditorSettings.lockAtlas = LightmapEditorSettingsWrapper.lockAtlas;
        LightmapEditorSettings.skyLightColor = LightmapEditorSettingsWrapper.skyLightColor;
        LightmapEditorSettings.skyLightIntensity = LightmapEditorSettingsWrapper.skyLightIntensity;
        LightmapEditorSettings.quality = LightmapEditorSettingsWrapper.quality;
        LightmapEditorSettings.bounceBoost = LightmapEditorSettingsWrapper.bounceBoost;
        LightmapEditorSettings.enableAmbientOcclusion = LightmapEditorSettingsWrapper.enableAmbientOcclusion;
        LightmapEditorSettings.finalGatherRays = LightmapEditorSettingsWrapper.finalGatherRays;
        LightmapEditorSettings.finalGatherGradientThreshold = LightmapEditorSettingsWrapper.finalGatherGradientThreshold;
        LightmapEditorSettings.finalGatherInterpolationPoints = LightmapEditorSettingsWrapper.finalGatherInterpolationPoints;
        LightmapEditorSettings.lastUsedResolution = LightmapEditorSettingsWrapper.lastUsedResolution;
        LightmapEditorSettings.bounceIntensity = LightmapEditorSettingsWrapper.bounceIntensity;
        ...
        LightmapEditorSettings.maxAtlasHeight = LightmapEditorSettingsWrapper.maxAtlasHeight;
        LightmapEditorSettings.finalGatherContrastThreshold = LightmapEditorSettingsWrapper.finalGatherContrastThreshold;
    ...
    class LightmapEditorSettingsWrapper
    {
        ...
        public int finalGatherRays;
        public float finalGatherGradientThreshold;
        public int finalGatherInterpolationPoints;
        public float lastUsedResolution;
        public float bounceIntensity;
        public float resolution;
        public LightmapEditorSettings.Sampling giPathTracerSampling;
        public LightmapEditorSettings.FilterType giPathTracerFilter;
        public int maxAtlasWidth;
        public int maxAtlasHeight;
        public float finalGatherContrastThreshold;

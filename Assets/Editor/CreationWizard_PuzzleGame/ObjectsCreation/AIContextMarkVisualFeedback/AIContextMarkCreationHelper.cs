    ...
    public class AIContextMarkCreationHelper
    {
         ...
         Transform modelObjectParent = null, Transform particleObjectParent = null)
        {
            ...
            for (var i = 0; i < meshRenderers.Length; i++)
            {
                ...
                var particleSystem = new GeneratedPrefabAssetManager<ParticleSystem>(GenericInformation.BaseAIFeedbackParticlesPrefab, GenericInformation.PathConfiguration.AIFeedbackPrefabPath,
                ...
                aIContextMarkVisualFeedbackEditorProfile.AddToGeneratedObjects(new UnityEngine.Object[] { particleSystem.SavedAsset });

...
public static class PathConstants 
{
    ...
    public const string PuzzleGameConfigurationManagerMethodTemplatePath = "Assets/Editor/CodeGeneration/Templates/PuzzleGameConfiguration/PuzzleGameConfigurationManagerMethodTemplate.txt";

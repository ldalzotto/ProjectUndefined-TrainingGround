...
// </auto-generated>
//------------------------------------------------------------------------------
            { typeof(GrabObjectModule), new InteractiveObjectModuleConfigurationProfile(
                new InteractiveObjectIdentifiedEditOperation(
                    (CommonGameConfigurations) => CommonGameConfigurations.PuzzleInteractiveObjectModulePrefabs.BaseGrabObjectModule,
                    (CommonGameConfigurations) => CommonGameConfigurations.PuzzleGameConfigurations.GrabObjectConfiguration,
                    (module) => ((GrabObjectModule)module).GrabObjectID, (module, id) => ((GrabObjectModule)module).GrabObjectID = (GrabObjectID)id,
                    (InteractiveObjectModuleWizardID) => InteractiveObjectModuleWizardID.GrabObjectID
                ),
                   new PrefabIdentifiableConditionOperation((CommonGameConfigurations) => CommonGameConfigurations.PuzzleGameConfigurations.GrabObjectConfiguration,
                            (InteractiveObjectModuleWizardID) => InteractiveObjectModuleWizardID.GrabObjectID,
                            typeof(Editor_GrabObjectCreationWizard.GrabObjectCreationWizard)),
...
// </auto-generated>
//------------------------------------------------------------------------------
            {typeof(InteractiveObjectCutsceneControllerModule), new InteractiveObjectModuleConfigurationProfile(
                        new InteractiveObjectNonIdentifiedEditOperation((CommonGameConfigurations CommonGameConfigurations) => CommonGameConfigurations.PuzzleInteractiveObjectModulePrefabs.BaseInteractiveObjectCutsceneControllerModule)
                      , new NoPrefabEditConditionOperation()
                      , "The object can be controlled by puzzle cutscene." )
            },
...
// </auto-generated>
//------------------------------------------------------------------------------
            { typeof(NearPlayerGameOverTriggerModule), new InteractiveObjectModuleConfigurationProfile(
                new InteractiveObjectIdentifiedEditOperation(
                    (CommonGameConfigurations) => CommonGameConfigurations.PuzzleInteractiveObjectModulePrefabs.BaseNearPlayerGameOverTriggerModule,
                    (CommonGameConfigurations) => CommonGameConfigurations.PuzzleGameConfigurations.NearPlayerGameOverTriggerConfiguration,
                    (module) => ((NearPlayerGameOverTriggerModule)module).NearPlayerGameOverTriggerID, (module, id) => ((NearPlayerGameOverTriggerModule)module).NearPlayerGameOverTriggerID = (NearPlayerGameOverTriggerID)id,
                    (InteractiveObjectModuleWizardID) => InteractiveObjectModuleWizardID.NearPlayerGameOverTriggerID
                ),
                   new PrefabIdentifiableConditionOperation((CommonGameConfigurations) => CommonGameConfigurations.PuzzleGameConfigurations.NearPlayerGameOverTriggerConfiguration,
                            (InteractiveObjectModuleWizardID) => InteractiveObjectModuleWizardID.NearPlayerGameOverTriggerID,
                           typeof(Editor_NearPlayerGameOverTriggerCreationWizard.NearPlayerGameOverTriggerCreationWizard)),
                   "When near player, a game over is triggered."
                )
            },
//${addNewEntry}
        };

...
//------------------------------------------------------------------------------
            {typeof(NearPlayerGameOverTriggerModule), new InteractiveObjectModuleConfigurationProfile(
                        new InteractiveObjectNonIdentifiedEditOperation((CommonGameConfigurations CommonGameConfigurations) => CommonGameConfigurations.PuzzleInteractiveObjectModulePrefabs.BaseNearPlayerGameOverTriggerModule)
                      , new NoPrefabEditConditionOperation()
                      , "Model object definition." )
            },

...
namespace Editor_GameDesigner
{
    ...
    public class RangeTypeObjectDefinitionConfigurationModule : ConfigurationModule<RangeTypeObjectDefinitionConfiguration, RangeTypeObjectDefinitionID, RangeTypeObjectDefinitionInherentData> { }
    public class InteractiveObjectTypeDefinitionConfigurationModule : ConfigurationModule<InteractiveObjectTypeDefinitionConfiguration, InteractiveObjectTypeDefinitionID, InteractiveObjectTypeDefinitionInherentData> { }
    //------------------------------------------------------------------------------
    // <auto-generated>
...
// </auto-generated>
//------------------------------------------------------------------------------
    public class AIObjectTypeDefinitionConfigurationModule : ConfigurationModule<AIObjectTypeDefinitionConfiguration, AIObjectTypeDefinitionID, AIObjectTypeDefinitionInherentData> { }
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool.
// </auto-generated>
//------------------------------------------------------------------------------
    public class AIObjectConfigurationModule : ConfigurationModule<AIObjectConfiguration, AIObjectID, AIObjectInherentData> { }
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool.
// </auto-generated>
//------------------------------------------------------------------------------
    public class PointOfInterestDefinitionConfigurationModule : ConfigurationModule<PointOfInterestDefinitionConfiguration, PointOfInterestDefinitionID, PointOfInterestDefinitionInherentData> { }
//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool.
// </auto-generated>
...
// </auto-generated>
//------------------------------------------------------------------------------
    public class AIPatrolGraphConfigurationModule : ConfigurationModule<AIPatrolGraphConfiguration, AIPatrolGraphID, AIPatrolGraphInherentData> { }
//${addNewEntry}

...
public class AdventureGamePrefabContainer : MonoBehaviour
{

    private static AdventureGamePrefabContainer instance;
    ...
    public static AdventureGamePrefabContainer Instance
    {
        get
        {
            if (instance == null)
            {
                instance = GameObject.FindObjectOfType<AdventureGamePrefabContainer>();
            }
            return instance;
        }
    }

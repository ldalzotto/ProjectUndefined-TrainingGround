...
namespace LevelManagement
{
    public class LevelChunkTracker : MonoBehaviour
    {
        ...
        public TransitionableLevelFXType TransitionableLevelFXType
        {
            get => transitionableLevelFXType;
        }

        public LevelChunkType AssociatedLevelChunkType
        {
            get => associatedLevelChunkType;
            set => associatedLevelChunkType = value;
        }
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                LevelManagerEventManager.Get().CORE_EVT_OnChunkLevelEnter(this);
            }
        }
        ...
        private void OnTriggerExit(Collider other)
        {
            if (other.tag == TagConstants.PLAYER_TAG)
            {
                LevelManagerEventManager.Get().CORE_EVT_OnChunkLevelExit(this);
            }
        }
